...
Lors de vos différentes discussions vous aurez des choix à faire. Certains pouvant vous amener à une _dead end_, (à savoir un game over), mieux vaut donc être prudent.  
