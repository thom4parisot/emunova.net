...
Ce n'est pas tout. Lorsque vous venez en douce pour faire non pas un _kill_ mais une exécution, lorsque vous êtes assez près près de votre future victime, Straweather vous _encourage_ et un viseur apparaît et selon le temps que vous appuyez sur un des deux boutons de frappe, vous définissez le niveau de violence (ou de _style_ selon le jeu) vous en avez trois : (dans notre exemple avec une batte en métal)  
...
Oser allez aussi loin dans la violence avec un jeu d'action axé infiltration était une idée à avoir**9/10**  
...
On reconnaît la _GTA touch_ dans le moteur graphique, l'ajout du filtre au moment des exécutions en plus des texture sales (un peu à la Silent Hill) rend l'ambiance encore plus malsaine. **8/10**  
