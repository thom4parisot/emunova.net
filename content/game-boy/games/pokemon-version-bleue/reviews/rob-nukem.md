...
rating: 5
type: review
published: 2011-05-15T11:06:25.000Z
legacy_url: http://www.emunova.net/veda/test/4109.htm
---
...
Les seules différences entre les Versions Rouge et Bleue sont l'apparition, dans la première, de certains Pokémon, comme Sabelette (et son évolution, Sablaireau), Goupix (et Feunard), Miaouss (et Persian), Chétiflor (et ses évolutions, Boustiflor et Empiflor), Magmar et Scarabrute.  

  

Dans la Version Rouge ce sont Abo (et son évolution, Arbok), Caninos (et Arcanin), Ferosinge (et Colossinge), Mystherbe (et ses évolutions, Ortide et Rafflésia), Elektek et Insécateur qui apparaissent, donnant un total de 139 Pokémon capturables par version, dont 11 à obtenir via les échanges.  
...
**Graphismes :** Certains sprites sont pixelisés, ainsi que certains décors, mais d'autres sont très beaux. La Game Boy se débrouille bien sur ce coup. (Et il n'y a aucune différence avec la version Rouge ; seule la Version Verte a des sprites de Pokemon différents.)  
