...
**Une évolution technique indiscutable **  
...
Si le gameplay reste le même, Sonic 2 évolue considérablement sur de nombreux points, notamment sur le plan graphique. Les développeurs de la Sonic Team ont parfaitement su maîtriser la machine pour nous offrir des graphismes particulièrement détaillés et superbement colorés, sans jamais sacrifier la vitesse, qui est encore plus grande que dans le premier opus.   

  

Les bonus stages désormais en 3D sont quand à eux plus qu'impressionnant pour la Megadrive.   
...
Durant le jeu normal, Tails suit automatiquement Sonic (ou du moins essaie de le suivre), mais un second joueur peut également le contrôler à tout moment.   
...
Ce second volet est bien plus long et plus difficile que le premier. Sans jamais en devenir décourageant, le jeu propose un véritable challenge.   
